...
namespace Capstone
{
    public class Menu
    {
        ...
        public void FeedMoney()
        {
            ...
            while (success == false)
            {
                ...
                try
                {
                    ...
                    Console.WriteLine($"Your current balance is {vendingMachine.UpdateBalanceDeposit(depositAmount).ToString("c", CultureInfo.GetCultureInfo("en-US"))}");
        ...
        {
            Console.Write("Please Select Item By Slot Number: ");
        ...
        {
            decimal change = vendingMachine.UpdateBalance();
            Console.WriteLine("Thank You For Your Purchase!");
            Console.WriteLine($"{vendingMachine.FinishTransaction(change)}");
